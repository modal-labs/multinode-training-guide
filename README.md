...
- [**`verifiers/`**](/verifiers) reinforcement learning training with GRPO to train a athematical reasoning model using the `verifiers` library with sandboxed code execution.
