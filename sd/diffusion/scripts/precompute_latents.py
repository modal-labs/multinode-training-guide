...
def build_streaming_laion_dataloader(
    ...
    **dataloader_kwargs,
    ...
    for resize in resize_size:
        ...
        transform.append(transforms.Compose([center_square_crop, lambda x: x[0], transforms.ToTensor(), normalize]))
...
def main(args: Namespace) -> None:
    ...
    remote_upload = os.path.join(args.remote_upload, str(dist.get_local_rank()))
    ...
    for batch_idx, batch in enumerate(tqdm(dataloader)):
        ...
        for i in range(latents_256.shape[0]):
            ...
            assert latents_256_sample != b'' or latents_512_sample != b''
            mds_sample = {
