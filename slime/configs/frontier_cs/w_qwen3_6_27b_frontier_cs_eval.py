...
worker (mounts slime-data) unless a pre-deployed FRONTIER_CS_JUDGE_URL is set.
    ...
    EXPERIMENT_CONFIG=frontier_cs.w_qwen3_6_27b_frontier_cs_eval uv run --no-dev modal run slime/modal_train.py::download_data
    EXPERIMENT_CONFIG=frontier_cs.w_qwen3_6_27b_frontier_cs_eval uv run --no-dev modal run -d slime/modal_train.py::train
"""
...
from configs.frontier_cs.w_qwen3_6_27b_frontier_cs_noncolocate_5n import _Slime, modal  # noqa: F401
