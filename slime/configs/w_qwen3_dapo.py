"""Qwen3-30B-A3B GRPO on DAPO-Math-17k — single node (1×8 H100), colocated.

Matches the repo's run-qwen3-30B-A3B.sh defaults, expressed in the config style
used by this guide repo.
"""
import os
from configs.base import ModalConfig, SlimeConfig, DATA_PATH, CHECKPOINTS_PATH

# Forward shell W&B env vars into the Modal image (read at image-build time).
_WANDB_IMAGE_ENV = {
